    ...
    if (componentName === "component 3") {
      this.setState({
        ...
        showLink4: true
			...
			alert('A link to component 4 is now present in the global navigation'); 
    }
    ...
    return (
      <div className="App">
        <Helmet>
          ...
          <meta charSet="utf-8" />
          <title>
            React Routing - Moving Focus to The Top due to global navigation change
          </title>
        </Helmet>
        ...
        <h1>
          React Routing - Moving Focus to the top due to a global navigation change
          {" "}
        </h1>
